...
import { faCalendar, faClock, faEdit, faFile } from "@fortawesome/free-regular-svg-icons"
import { faEllipsisH, faPlus, faPrint, faTrash } from "@fortawesome/free-solid-svg-icons"
                    ...
                    <div className="modal-box md:w-full md:max-w-[600px] dark:bg-zinc-800">
                        ...
                        <div className="space-y-2 relative overflow-auto w-full max-h-[300px]">
                            {Array.from({ length: 50 }).map((_, index) => (
                                <button key={index} type="button" className="w-full p-3 rounded-lg border text-start flex items-center justify-between hover:border-zinc-100/0 hover:bg-zinc-100 transition-all duration-300">
